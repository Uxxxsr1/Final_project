# client.py - поместите в корень Final_project-main
import sys
import os
import requests
...
class LoginWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.setStyleSheet("""
            ...
            QPushButton:hover { background-color: #2d2e2d; }
            QFrame {
                background-color: white;
                border-radius: 12px;
            }
        ...
        self.register_button.setStyleSheet("QPushButton { background-color: #95a5a6; }")
